...
public class AppConstants {
  ...
  public static final String TODAY_SCHEDULE_COMMAND = "/day";
  public static final String NEXT_DAY_SCHEDULE = "Розклад на завтра";
  public static final String NEXT_DAY_SCHEDULE_COMMAND = "/nextday";
  public static final String WEEK_SCHEDULE = "Розклад на тиждень";
  public static final String WEEK_SCHEDULE_COMMAND = "/week";
  public static final String NEXT_WEEK_SCHEDULE = "Розклад на наступний тиждень";
  public static final String NEXT_WEEK_SCHEDULE_COMMAND = "/nextweek";
  public static final String CUSTOM_SCHEDULE = "Розклад за власний проміжок часу";
