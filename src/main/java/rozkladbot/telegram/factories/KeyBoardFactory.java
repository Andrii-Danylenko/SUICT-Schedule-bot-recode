...
import static rozkladbot.constants.AppConstants.CUSTOM_SCHEDULE;
import static rozkladbot.constants.AppConstants.CUSTOM_SCHEDULE_COMMAND;
import static rozkladbot.constants.AppConstants.NEXT_DAY_SCHEDULE;
import static rozkladbot.constants.AppConstants.NEXT_DAY_SCHEDULE_COMMAND;
import static rozkladbot.constants.AppConstants.NEXT_WEEK_SCHEDULE;
import static rozkladbot.constants.AppConstants.NEXT_WEEK_SCHEDULE_COMMAND;
import static rozkladbot.constants.AppConstants.SETTINGS;
import static rozkladbot.constants.AppConstants.SETTINGS_COMMAND;
import static rozkladbot.constants.AppConstants.TODAY_SCHEDULE;
import static rozkladbot.constants.AppConstants.TODAY_SCHEDULE_COMMAND;
import static rozkladbot.constants.AppConstants.WEEK_SCHEDULE;
import static rozkladbot.constants.AppConstants.WEEK_SCHEDULE_COMMAND;
...
public final class KeyBoardFactory {
    ...
    public static InlineKeyboardMarkup getCommandsList() {
        ...
        dayButton.setText(TODAY_SCHEDULE);
        dayButton.setCallbackData(TODAY_SCHEDULE_COMMAND);
        row1.add(dayButton);
        buttons.add(row1);
        List<InlineKeyboardButton> row2 = new ArrayList<>();
        InlineKeyboardButton ndayButton = new InlineKeyboardButton();
        ndayButton.setText(NEXT_DAY_SCHEDULE);
        ndayButton.setCallbackData(NEXT_DAY_SCHEDULE_COMMAND);
        row2.add(ndayButton);
        buttons.add(row2);
        List<InlineKeyboardButton> row3 = new ArrayList<>();
        InlineKeyboardButton weekButton = new InlineKeyboardButton();
        weekButton.setText(WEEK_SCHEDULE);
        weekButton.setCallbackData(WEEK_SCHEDULE_COMMAND);
        row3.add(weekButton);
        buttons.add(row3);
        List<InlineKeyboardButton> row4 = new ArrayList<>();
        InlineKeyboardButton nweekButton = new InlineKeyboardButton();
        nweekButton.setText(NEXT_WEEK_SCHEDULE);
        nweekButton.setCallbackData(NEXT_WEEK_SCHEDULE_COMMAND);
        row4.add(nweekButton);
        buttons.add(row4);
        List<InlineKeyboardButton> row5 = new ArrayList<>();
        InlineKeyboardButton customButton = new InlineKeyboardButton();
        customButton.setText(CUSTOM_SCHEDULE);
        customButton.setCallbackData(CUSTOM_SCHEDULE_COMMAND);
        row5.add(customButton);
        buttons.add(row5);
        List<InlineKeyboardButton> row6 = new ArrayList<>();
        InlineKeyboardButton settingsButton = new InlineKeyboardButton();
        settingsButton.setText(SETTINGS);
        settingsButton.setCallbackData(SETTINGS_COMMAND);
